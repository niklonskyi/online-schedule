  ...
  <div class="container py-3">
    <form v-on:submit="handleSubmit">
      <div class="mb-3">
        ...
        <input type="text" class="form-control" required maxlength="30" v-model="nameOfSchedule">
      </div>
      <div class="mb-3">
      ...
      <div class="mb-3">
        ...
        <input type="time" class="form-control" required maxlength="30" v-model="time">
      </div>
      <div class="mb-3">
        <label class="form-label">Classroom</label>
        <input type="text" class="form-control" required maxlength="30" v-model="classroom">
      </div>
